...
import net.runelite.osrsbb.wrappers.RSGroundItem;
...
public class RSItemHelper {
    ...
    public static boolean use(int itemID){
        ...
        ItemComposition rsItemDefinition = Web.methods.badLite.getItemManager().getItemComposition(itemID);
        String itemName;
    ...
    public static boolean isNoted(int id) {
        ItemComposition definition = Web.methods.badLite.getItemManager().getItemComposition(id);
