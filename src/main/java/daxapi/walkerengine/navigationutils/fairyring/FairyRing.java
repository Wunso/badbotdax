package daxapi.walkerengine.navigationutils.fairyring;
...
import static daxapi.walkerengine.navigationutils.fairyring.letters.FirstLetter.*;
import static daxapi.walkerengine.navigationutils.fairyring.letters.SecondLetter.*;
import static daxapi.walkerengine.navigationutils.fairyring.letters.ThirdLetter.*;
...
public class FairyRing {
	...
	private static RSWidget getTeleportButton() {
		return Web.methods.interfaces.getComponent(INTERFACE_MASTER, TELEPORT_CHILD);
	}
